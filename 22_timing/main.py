...
def load_media():
    ...
    if not g_prompt.load_from_rendered_text('Press Enter to reset start time.', text_color):
    ...
    if not init():
        ...
        if not load_media():
            ...
            while not quit:
                ...
                time_text = f'Milliseconds since start time: {sdl2.SDL_GetTicks() - start_time}'
